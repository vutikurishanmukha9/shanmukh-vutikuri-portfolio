      ...
      <div className="container mx-auto px-4 lg:px-8 py-12">
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social, index) => (
                <a
                  ...
                  className="p-2 bg-background/50 hover:bg-primary/10 border border-border hover:border-primary/30 rounded-lg transition-all duration-300 group"
                >
        ...
        <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <Button
            ...
            size="icon"
            onClick={scrollToTop}
            className="mt-4 md:mt-0 hover:bg-primary/10 hover:text-primary"
          >
